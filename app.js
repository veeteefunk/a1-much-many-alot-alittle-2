...
form.addEventListener('submit', function(e) {
    ...
    ex1 == "a lot" ? iconAnswer1.classList.add("fa-circle-check") : iconAnswer1.classList.add("fa-circle-xmark");
    ex2 == "many" ? iconAnswer2.classList.add("fa-circle-check") : iconAnswer2.classList.add("fa-circle-xmark");
    ex3 == "much" ? iconAnswer3.classList.add("fa-circle-check") : iconAnswer3.classList.add("fa-circle-xmark");
    ex4 == "a lot" ? iconAnswer4.classList.add("fa-circle-check") : iconAnswer4.classList.add("fa-circle-xmark");
    ex5 == "a little" ? iconAnswer5.classList.add("fa-circle-check") : iconAnswer5.classList.add("fa-circle-xmark");
    ex6 == "a few" ? iconAnswer6.classList.add("fa-circle-check") : iconAnswer6.classList.add("fa-circle-xmark");
    ex7 == "many" ? iconAnswer7.classList.add("fa-circle-check") : iconAnswer7.classList.add("fa-circle-xmark");
    ex8 == "a few" ? iconAnswer8.classList.add("fa-circle-check") : iconAnswer8.classList.add("fa-circle-xmark");
    ex9 == "much" ? iconAnswer9.classList.add("fa-circle-check") : iconAnswer9.classList.add("fa-circle-xmark");
    ex10 == "a lot" ? iconAnswer10.classList.add("fa-circle-check") : iconAnswer10.classList.add("fa-circle-xmark");
});
